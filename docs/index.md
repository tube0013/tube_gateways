...
For users on HASSOS or Home Assistant Supervised, there is an addon repository containing firmware flashing tools and other utilities.
...
## Current Products
**Links to the latest Firmware and Source files**
...
## Retired Products
**Links to the latest Firmware and Source files for previous hardware versions**
